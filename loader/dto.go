...
type (
	...
	// as HTTP_PROXY, HTTPS_PROXY, and NO_PROXY environment variables.
	// All three fields are optional and are omitted from the child environment when empty.
	Proxy struct {
...
// for maximum compatibility across tools. Returns nil when the receiver is nil or
